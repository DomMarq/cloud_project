...
TRAIN_AND_VALID_INDEX = random.sample(ALL, int(len(ALL) * 0.6))
TEST_INDEX = list(set(ALL) - set(TRAIN_AND_VALID_INDEX))

TRAIN_INDEX = random.sample(TRAIN_AND_VALID_INDEX, int(len(TRAIN_AND_VALID_INDEX) * 0.83333333))
...
checkpoint_path = "checkpoints/training_50_10_10/cp.ckpt"
...
# save model
model.save('saved_models/model_50_10_10')
