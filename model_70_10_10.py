...
TRAIN_INDEX = random.sample(TRAIN_AND_VALID_INDEX, int(len(TRAIN_AND_VALID_INDEX) * 0.875))
...
checkpoint_path = "checkpoints/training_70_10_10/cp.ckpt"
...
# save model
model.save('saved_models/model_70_10_10')
